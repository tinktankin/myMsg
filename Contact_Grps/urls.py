...
from .views import createcontacts,contact,group,creategroup,ContactUpdateView,GroupUpdateView,import_csvfiles
urlpatterns = [
    ...
    path('import_contacts/',import_csvfiles,name="import")
]